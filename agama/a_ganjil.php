            ...
            <div class="mata">
                ...
                <div id="myDiv" style="display: none;">
                    ...
                    <div class="inpuan">
                        <div class="dari">
                            <p1>Dari Kelas</p1>
                            <input type="text" id="dariKelas" value="<?php echo isset($datatampil['Kelas']) ? $datatampil['Kelas'] : ''; ?> "readonly>
                        </div>
...
<script>
    ...
    select.addEventListener("change", function() {
        if (select.value === "ganjil") {
            window.location.href = "a_ganjil.php";
        } else if (select.value === "genap") {
            window.location.href = "a_genap.php";
        }
    });
</script>
