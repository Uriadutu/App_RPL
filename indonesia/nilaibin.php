...
<body>
      <?php include "b_ganjil.php" ?>
      <div class="pop">
        <div class="up">
            <form method="POST">
                <div class="balik">
                    <a href="b_ganjil.php">Kembali</a>
...
$idAgama = $_GET['NISN'];
$coba = mysqli_query($koneksi, "SELECT * FROM b_indo WHERE id_indo = '$idAgama'");
while ($genap = mysqli_fetch_array($coba)) {
    $nim = $genap['NISN'];
    $ambildata = mysqli_query($koneksi, "SELECT * FROM siswa WHERE NISN = '$nim'");
